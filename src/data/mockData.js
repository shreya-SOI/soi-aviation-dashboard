...
export const companies = {
  SOI: {
    ...
    openSOs: 31,
    openPOs: 22,
    contacts: ['James Harrington — CEO', 'Maria Delacroix — CFO', 'Tariq Rahman — VP Operations'],
  ...
  CAS: {
    ...
    openPOs: 8,
    onTime: '94%',
    contacts: ['David Chen — Account Manager', 'Susan Park — Contracts'],
  ...
  NanoTech: {
    name: 'NanoTech Systems',
    role: 'Preferred Supplier',
    country: 'Israel',
    spend: 680_000,
    openPOs: 6,
    onTime: '88%',
    contacts: ['Eran Goldstein — Director BD', 'Anat Levy — Technical Support'],
  ...
  RedSun: {
    ...
    openPOs: 8,
    onTime: '81%',
    contacts: ['Khalid Al-Mansouri — CEO', 'Fatima Nasser — Sales'],
